module.exports = function ( content, file, stream, done ) {
  ...
  var funcStart = 'var document = global.document; if (document) { var head = document.getElementsByTagName("head")[0]; var style = document.createElement("style"); style.type = "text/css";';
  ...
  compileLess( file, { compress: true } ).then( function ( result ) {
    return autoPrefix( result.css, {
      ...
      /*eslint-disable*/
      compiled = 'var css = "' + compiled.replace( /\\/g, '\\\\' ).replace( /'/g, '\\$&' ).replace( /"/g, '\\$&' ) + '";' + funcStart + '\n' + funcEnd;
      /*eslint-enable*/
      compiled += '\n\n' + 'module.exports = { css: css, tokens: {} }\n\n';
